...
def swap_channel(coupling, residual_factors, qubit_freqs, taus, Cqq=0.012):
...
def leak_channel(coupling, residual_factors, qubit_01freqs, qubit_12freqs, taus, Cqq = 0.012):
